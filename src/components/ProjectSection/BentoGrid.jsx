    ...
    <>
      <section id="projects" className="relative min-h-screen py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            <div className="bg-black/80 backdrop-blur-sm border border-cyan-400/30 rounded-lg px-6 py-3">
              <div className="flex items-center space-x-4 font-mono text-sm">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                  <span className="text-green-400">SYSTEM_STATUS: OPERATIONAL</span>
                </div>
                <div className="text-gray-400">|</div>
                <div className="text-cyan-400">
                  PROJECTS_LOADED: {userData.projects?.length || 0}
                </div>
                <div className="text-gray-400">|</div>
